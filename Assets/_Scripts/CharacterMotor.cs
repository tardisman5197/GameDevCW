...
public class CharacterMotor : MonoBehaviour 
{
    ...
    private int animiatorWalkingSpeedID;
    ...
    void Awake()
	{
        ...
        animiatorWalkingSpeedID = Animator.StringToHash("walkingSpeed");
	...
	void Update() 
	{
        ...
        else
        {
            ...
            this.GetComponent<Animator>().SetFloat(animiatorWalkingSpeedID, currentSpeed);
        }
    }
